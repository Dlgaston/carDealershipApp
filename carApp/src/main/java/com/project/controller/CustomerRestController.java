...
//	public ModelAndView create_Account(Model model) {
//		return new ModelAndView("create-account", "customer", new Customer());
//	}
//	
//	@RequestMapping(value ="/create-account",method = RequestMethod.POST)
//	public String handle_SignUp(Model model, @ModelAttribute("customer") Customer customer, HttpSession session) {
//		customerService.addCustomer(customer);
//		return "index";
//	}
//	@RequestMapping(value ="/buy-vehicle",method = RequestMethod.GET)
//	public String add_Customer(Model model, @RequestParam int id, HttpSession session) {
...
//		return "buy-vehicle";
//	}
//	@RequestMapping(value ="/buy-vehicle",method = RequestMethod.POST)
//	public String handle_BuyVehicle(Model model, @ModelAttribute("customer") Customer customer, @ModelAttribute("vehicleOne") Vehicle vehicle,
